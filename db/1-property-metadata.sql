-- Table: camdecmpsaux.property_metadata

-- DROP TABLE camdecmpsaux.property_metadata;
CREATE TABLE camdecmpsaux.property_metadata
(
...
COMMENT ON TABLE camdecmpsaux.property_metadata
...
COMMENT ON COLUMN camdecmpsaux.property_metadata.property_id
    IS 'Record Identifier for the property_metadata metadata';

COMMENT ON COLUMN camdecmpsaux.property_metadata.name
    IS 'Name of database column or generic property_metadata name';

COMMENT ON COLUMN camdecmpsaux.property_metadata.json_name
    IS 'Serialized JSON property_metadata name';

COMMENT ON COLUMN camdecmpsaux.property_metadata.display_name
    IS 'Name displayed in applications & csv files';

COMMENT ON COLUMN camdecmpsaux.property_metadata.description
    IS 'Full description of a property_metadata';

COMMENT ON COLUMN camdecmpsaux.property_metadata.table_name
    IS 'Table name property_metadata is associated with';

COMMENT ON COLUMN camdecmpsaux.property_metadata.sample_value
    IS 'Sample data for the property_metadata';


insert into camdecmpsaux.property_metadata(name, json_name, display_name, description, table_name, sample_value)
...
insert into camdecmpsaux.property_metadata(name, json_name, display_name, description, table_name, sample_value)
values('begin_date', 'beginDate', 'Begin Date', 'Begin Date of a record.', null, null);

insert into camdecmpsaux.property_metadata(name, json_name, display_name, description, table_name, sample_value)
values('end_date', 'endDate', 'Begin Date', 'End Date of a record.', null, null);

insert into camdecmpsaux.property_metadata(name, json_name, display_name, description, table_name, sample_value)
values('monitor_locations', 'locations', 'Monitor Locations', 'Monitor Locations for a Monitor Plan.', null, null);